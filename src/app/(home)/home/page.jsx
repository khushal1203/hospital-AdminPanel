    ...
    <div className="relative min-h-screen">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 py-12">
        ...
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-32 w-32 items-center justify-center overflow-hidden rounded-full border-4 border-white bg-gray-100 shadow-xl">
            {loading ? (
              <HomeSpinner />
            ) : (
              <Image
          ...
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white">
            {loading ? (
              <div className="mx-auto h-8 w-48 animate-pulse rounded bg-gray-200"></div>
            ) : (
              user?.fullName || "User"
            )}
          </h1>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {filteredCards.map((card, index) => {
            return (
              ...
              >
                <div
                  className={`mb-4 inline-flex rounded-xl bg-gradient-to-br ${card.color} p-4`}
                >
                  <Image
                    src={card.icon}
                    alt={card.title}
