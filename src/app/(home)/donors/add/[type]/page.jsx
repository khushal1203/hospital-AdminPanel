  ...
  const getFormSections = () => {
    return [
      ...
      },
      {
        ...
        fields: ["placeOfBirth", "religion", "bloodGroup"],
        color: "purple",
      },
      {
      ...
      },
      {
        ...
        fields: ["lmpDate", "lmpDay", "etValue", "rightOvary", "leftOvary"],
        color: "pink",
      },
      {
        title: "Physical Attributes",
        fields: ["height", "weight", "skinColor", "hairColor", "eyeColor"],
        color: "cyan",
      },
      {
        title: "Obstetric History",
        fields: ["numberOfDeliveries", "numberOfAbortions", "otherNotes"],
        color: "teal",
      },
      {
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    {formData.age && (
                      <p
                        className={`mt-1 text-sm ${parseInt(formData.age) >= 23 && parseInt(formData.age) <= 35 ? "text-green-600" : "text-red-600"}`}
                      >
                        {parseInt(formData.age) >= 23 &&
                        parseInt(formData.age) <= 35
                          ? "✓ Eligible (Age between 23 to 35 years)"
                          : "✗ Not eligible"}
                      </p>
                    )}
                  </div>
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <div className="flex">
                      <span className="inline-flex items-center rounded-l-lg border border-r-0 border-gray-300 bg-gray-50 px-3 text-gray-500 dark:border-gray-600 dark:bg-gray-600 dark:text-gray-400">
                        +91
                      </span>
                      <input
                        type="tel"
                        ...
                        onChange={handleChange}
                        className="w-full rounded-r-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                        required
                      />
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      value={formData.donorOccupation}
                      onChange={handleChange}
                      className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                    />
                  </div>
              ...
              >
                      ...
                      <tr>
                        ...
                        <td className="border border-gray-300 px-4 py-2 dark:border-gray-600">
                          <input
                            ...
                            onChange={handleChange}
                            placeholder="-"
                            className="w-full rounded border-0 bg-transparent focus:outline-none"
                          />
                        </td>
                        <td className="border border-gray-300 px-4 py-2 dark:border-gray-600">
                          <textarea
                            ...
                            className="w-full resize-none rounded border-0 bg-transparent focus:outline-none"
                            rows="2"
                          ></textarea>
                        </td>
                        <td className="border border-gray-300 px-4 py-2 dark:border-gray-600">
                ...
                <div className="mt-6">
                  <label className="flex items-center space-x-3">
                    <input
                      type="checkbox"
                      name="stimulationProcess"
                      checked={formData.stimulationProcess}
                      onChange={handleChange}
                      className="rounded border-gray-300 text-blue-600 focus:ring-blue-500"
                    />
                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">
                      Do you want to add the Stimulation Process Start Date?
                    </span>
                  </label>
                  {formData.stimulationProcess && (
                    <div className="mt-4">
                      <DatePicker
                        ...
                        selected={
                          formData.processStartDate
                            ? new Date(formData.processStartDate)
                            : null
                        }
                        onChange={(date) =>
                          setFormData((prev) => ({
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-4">
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={formData.menstrualHistory === true}
                          onChange={() =>
                            setFormData((prev) => ({
                              ...prev,
                              menstrualHistory:
                                formData.menstrualHistory === true
                                  ? null
                                  : true,
                            }))
                          }
                          className="mr-2 rounded border-gray-300 text-[#402575] focus:ring-2 focus:ring-[#402575]"
                        />
                        <span>Yes</span>
                      </label>
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={formData.menstrualHistory === false}
                          onChange={() =>
                            setFormData((prev) => ({
                              ...prev,
                              menstrualHistory:
                                formData.menstrualHistory === false
                                  ? null
                                  : false,
                            }))
                          }
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex space-x-4">
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={formData.contraceptives === true}
                          onChange={() =>
                            setFormData((prev) => ({
                              ...prev,
                              contraceptives:
                                formData.contraceptives === true ? null : true,
                            }))
                          }
                          className="mr-2 rounded border-gray-300 text-[#402575] focus:ring-2 focus:ring-[#402575]"
                        />
                      ...
                      <label className="flex items-center">
                        <input
                          type="checkbox"
                          checked={formData.contraceptives === false}
                          onChange={() =>
                            setFormData((prev) => ({
                              ...prev,
                              contraceptives:
                                formData.contraceptives === false
                                  ? null
                                  : false,
                            }))
                          }
                          ...
                          <input
                            ...
                            onChange={() =>
                              setFormData((prev) => ({
                                ...prev,
                                [item.key]:
                                  formData[item.key] === true ? null : true,
                              }))
                            }
                            className="mr-2 rounded border-gray-300 text-[#402575] focus:ring-2 focus:ring-[#402575]"
                          />
                          ...
                          <input
                            ...
                            onChange={() =>
                              setFormData((prev) => ({
                                ...prev,
                                [item.key]:
                                  formData[item.key] === false ? null : false,
                              }))
                            }
                            className="mr-2 rounded border-gray-300 text-[#402575] focus:ring-2 focus:ring-[#402575]"
                          />
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    <textarea
                      ...
                      onChange={(e) =>
                        handleDocumentChange("healthInsurance", e.target.value)
                      }
                      className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                      rows="3"
                    ></textarea>
                ...
                <div className="mb-8">
                  ...
                  <div className="space-y-4">
                    <textarea
                      ...
                      onChange={(e) =>
                        handleDocumentChange("lifeInsurance", e.target.value)
                      }
                      className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                      rows="3"
                    ></textarea>
                    ...
                    >
                      ...
                      <div className="space-y-4">
                        <input
                          ...
                          value={report.title}
                          onChange={(e) =>
                            handleDocumentChange("title", e.target.value, index)
                          }
                          className="w-full rounded-lg border border-gray-300 bg-white px-4 py-3 text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                        />
                        <textarea
                    ...
                    return (
                      <div key={index} className="relative">
                        ...
                        {index < getFormSections().length - 1 && (
                          <div
                            className="absolute top-8 h-10 w-0.5 bg-gray-200 dark:bg-gray-600"
                            style={{ left: "22px" }}
                          ></div>
                        )}

                        <div className="flex items-start space-x-3 rounded-lg p-2 transition-colors hover:bg-gray-50 dark:hover:bg-gray-700">
                          {/* Step Number/Status */}
                          <div
                            ...
                            style={
                              isComplete ? { backgroundColor: "#402575" } : {}
                            }
                          >
                            {isComplete ? (
