...
const TimelineItem = ({ title, status, date, isLast, donor, onDocumentUpload }) => {
    ...
    if (status === 'uploaded' || status === 'signed') {
        ...
        statusBadge = <span className="text-[10px] font-bold text-green-600">Completed</span>
    }
        ...
        <div className="relative flex gap-4 pb-8">
            ...
            <div className="flex flex-1 flex-col pt-1">
                <div className="flex items-center justify-between">
                    ...
                    {status === 'pending' && ["Consent Form", "Affidavit Form", "Insurance Documents", "Blood Report", "OPU Process"].includes(title) && (
                        <button 
