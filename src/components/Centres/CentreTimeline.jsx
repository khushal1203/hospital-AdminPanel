...
export default function CentreTimeline({ centre }) {
  ...
  const getSectionStatus = (section) => {
    switch (section) {
      ...
      case 'doctor':
        return centre?.doctorName && centre?.doctorPhoneNumber && centre?.doctorEmail && centre?.medicalLicenseNumber ? 'completed' : 'pending';
      case 'verification':
  ...
  const steps = [
    ...
    },
    {
      ...
      date: centre?.updatedAt,
      description: "Doctor details and medical license"
    },
    {
